...
csv_files = snakemake.input.clim_files
hydro_files = snakemake.input.hydro_files
variables = snakemake.params.plot_variables  # ['p', 'ep', 'Q']
outputfile = snakemake.output.output_png  #'output/plot_results_example.png'

# Combine csv files from weather generator and hydrology
csv_files.extend(hydro_files)
